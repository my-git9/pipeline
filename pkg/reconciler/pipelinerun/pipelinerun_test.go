...
taskRuns:
  %s%s:
    ...
    status: {}
  startTime: %s
`, prName, v1beta1.PipelineRunSpecStatusCancelledRunFinally, apis.ConditionSucceeded, corev1.ConditionUnknown, v1beta1.PipelineRunReasonRunning.String(), prName, ptName, ptName, now.Format(time.RFC3339))),
	}
	trs := []*v1beta1.TaskRun{
		getTaskRun(
			t,
